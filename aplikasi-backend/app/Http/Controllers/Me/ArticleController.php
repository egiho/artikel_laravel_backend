...
class ArticleController extends Controller
{
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        // (jika line ini dieksekusi artinya article ini bukan milik user yg login) kembalikan response 401, unauthorized
    ...
    public function destroy($id)
    {
        ...
        // jika iya maka kembalikan response success
        // (jika kode ini dieksekusi maka artinya article gagal didelete) kembalikan response error 500
